...
public class ContactDialogViewModel implements ViewModel {
	...
	public void initialize() {
		valid.bind(Bindings.and(dialogScope.contactFormValidProperty(), dialogScope.addressFormValidProperty()));
		dialogScope.bothFormsValidProperty().bind(valid);
		dialogScope.subscribe(ContactDialogScope.RESET_DIALOG_PAGE, (key, payload) -> resetDialogPage());
